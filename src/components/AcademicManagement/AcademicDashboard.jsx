  ...
  useEffect(() => {
    const fetchClasses = async () => {
      try {
        ...
        // Aseguramos que los nombres de las propiedades coincidan con lo que SessionCards espera
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#08060d] flex items-center justify-center">
        <p className="text-white text-xl animate-pulse">Cargando clases...</p>
      </div>
    );
  }
      ...
      <main>
        ...
        <div className="mb-10 p-6 bg-blue-950/20 border border-blue-900 rounded-2xl">
            ...
            <p className="text-blue-300 text-sm mt-1">
              {classes.length > 0 
                ? `Tienes ${classes.length} sesiones programadas para hoy.` 
        ...
        {error ? (
          ...
          /* SUSTITUCIÓN:
             En lugar de hacer el .map aquí, llamamos a SessionCards.
             Este componente ya tiene la cuadrícula (grid) y la lógica del QR.
          */
